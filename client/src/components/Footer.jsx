...
const Footer = () => {
    return (
        <footer className="w-full bg-neutral-950 border-t border-neutral-800/50 mt-16">

            <div className="max-w-6xl mx-auto w-full px-4 md:px-8 pt-16">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10">

                    <div>
                        <p className="text-neutral-500 text-base leading-relaxed mb-6 max-w-md">
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            <a
                                ...
                                aria-label="LinkedIn"
                            >
                                <FaLinkedin className="w-7 h-7 text-neutral-400 hover:text-white transition-colors duration-200" />
                            </a>
                            <a
                                ...
                                aria-label="GitHub"
                            >
                                <FaGithub className="w-7 h-7 text-neutral-400 hover:text-white transition-colors duration-200" />
                            </a>
                        </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-2">
                    ...
                    <p className="text-sm text-neutral-600">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-medium text-neutral-400 hover:text-white transition-colors duration-200"
                        >
                            Abhinav Mathur
                        </a>{' '}
                        🇮🇳
