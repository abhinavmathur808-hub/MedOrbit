                                ...
                                <div className="rounded-2xl p-6" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                                    ...
                                    <form onSubmit={handleSaveProfile} className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input type="text" name="name" value={formData.name} onChange={handleChange} className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-800 rounded-xl focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 outline-none text-white placeholder-zinc-600" />
                                        </div>
                                        <div>
                                            <label className="profile-label block text-sm font-medium text-white mb-2">Email</label>
                                            <input type="email" value={formData.email} disabled className="w-full px-4 py-3 bg-zinc-950/30 border border-zinc-800 rounded-xl text-zinc-500" />
                                        </div>
                                        <div>
                                            <label className="profile-label block text-sm font-medium text-white mb-2">Phone</label>
                                            <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="+91 12345 67890" className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-800 rounded-xl focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 outline-none text-white placeholder-zinc-600" />
                                        </div>
                                        <div>
                                            <label className="profile-label block text-sm font-medium text-white mb-2">Gender</label>
                                            <select name="gender" value={formData.gender} onChange={handleChange} className="w-full px-4 py-3 bg-zinc-950 border border-zinc-800 rounded-xl focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 outline-none text-white">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" name="dob" value={formData.dob} onChange={handleChange} className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-800 rounded-xl focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 outline-none text-white" />
                                        </div>
                                        <div className="md:col-span-2">
                                            <label className="profile-label block text-sm font-medium text-white mb-2">Address Line 1</label>
                                            <input type="text" name="addressLine1" value={formData.addressLine1} onChange={handleChange} placeholder="Street address" className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-800 rounded-xl focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 outline-none text-white placeholder-zinc-600" />
                                        </div>
                                        <div className="md:col-span-2">
                                            <label className="profile-label block text-sm font-medium text-white mb-2">Address Line 2</label>
                                            <input type="text" name="addressLine2" value={formData.addressLine2} onChange={handleChange} placeholder="City, State, PIN" className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-800 rounded-xl focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 outline-none text-white placeholder-zinc-600" />
                                        </div>
                                        <div className="md:col-span-2">
                        ...
                        <div className="rounded-2xl shadow-2xl max-w-md w-full p-6" style={{ background: '#18181b', border: '1px solid var(--card-border)' }}>
                            ...
                            <form onSubmit={handleAddMedicalHistory} className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" value={newRecord.diagnosis} onChange={(e) => setNewRecord({ ...newRecord, diagnosis: e.target.value })} placeholder="e.g. Flu, Migraine" className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-700 rounded-xl focus:ring-2 focus:ring-rose-500 outline-none text-white placeholder-zinc-600" required />
                                </div>
                                <div>
                                    <label className="profile-label block text-sm font-medium text-white mb-2">Date *</label>
                                    <input type="date" value={newRecord.date} onChange={(e) => setNewRecord({ ...newRecord, date: e.target.value })} className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-700 rounded-xl focus:ring-2 focus:ring-rose-500 outline-none text-white" required />
                                </div>
                                <div>
                                    <label className="profile-label block text-sm font-medium text-white mb-2">Treatment</label>
                                    <input type="text" value={newRecord.treatment} onChange={(e) => setNewRecord({ ...newRecord, treatment: e.target.value })} placeholder="Prescribed medications" className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-700 rounded-xl focus:ring-2 focus:ring-rose-500 outline-none text-white placeholder-zinc-600" />
                                </div>
                                <div>
                                    <label className="profile-label block text-sm font-medium text-white mb-2">Doctor Name</label>
                                    <input type="text" value={newRecord.doctorName} onChange={(e) => setNewRecord({ ...newRecord, doctorName: e.target.value })} placeholder="Dr. Name" className="w-full px-4 py-3 bg-zinc-950/50 border border-zinc-700 rounded-xl focus:ring-2 focus:ring-rose-500 outline-none text-white placeholder-zinc-600" />
                                </div>
