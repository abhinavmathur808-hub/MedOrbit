                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div className="rounded-2xl p-6 hover:-translate-y-0.5 transition-all duration-200" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                            <div className="flex items-center gap-4">
                                <div className="w-14 h-14 bg-rose-600/10 rounded-xl flex items-center justify-center">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div className="relative max-w-xs w-full">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2 bg-zinc-950/50 border border-zinc-800 rounded-lg focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 outline-none text-sm text-white placeholder-zinc-600"
                                    />
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td className="py-4 px-6 text-center">
                                                    {doctor.isVerified ? (
                                                        ...
                                                        <button
                                                            ...
                                                            className="inline-flex items-center gap-1 px-3 py-1.5 bg-rose-600 hover:bg-rose-500 text-white rounded-lg text-sm font-medium disabled:opacity-50"
                                                        >
