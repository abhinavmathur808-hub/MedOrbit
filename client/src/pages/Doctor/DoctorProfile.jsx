            ...
            <div className="min-h-screen bg-neutral-950">
                <div className="min-h-[calc(100vh-64px)] flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <p className="text-neutral-400">Loading fresh data...</p>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="rounded-2xl p-6 mb-6" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                        <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                            <div className="w-24 h-24 bg-gradient-to-br from-burgundy-600 to-burgundy-800 rounded-2xl flex items-center justify-center text-white text-3xl font-bold shadow-lg overflow-hidden">
                            ...
                            <Link
                                ...
                                className="flex items-center space-x-2 bg-burgundy-600/10 hover:bg-burgundy-600/20 text-burgundy-400 px-4 py-2 rounded-xl transition-all border border-burgundy-600/20"
                            >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div className="rounded-xl p-4 text-center" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                            <Clock className="w-8 h-8 text-burgundy-500 mx-auto mb-2" />
                            <p className="text-2xl font-bold text-white">{experience}</p>
                            <p className="text-neutral-500 text-sm">Years Exp.</p>
                        </div>
                        <div className="rounded-xl p-4 text-center" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                            <DollarSign className="w-8 h-8 text-burgundy-400 mx-auto mb-2" />
                            <p className="text-2xl font-bold text-white">₹{fees}</p>
                            <p className="text-neutral-500 text-sm">Consultation</p>
                        </div>
                        <div className="rounded-xl p-4 text-center" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                            <Award className="w-8 h-8 text-emerald-400 mx-auto mb-2" />
                            <p className="text-2xl font-bold text-white">{qualifications?.length || 0}</p>
                            <p className="text-neutral-500 text-sm">Qualifications</p>
                        </div>
                        <div className="rounded-xl p-4 text-center" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                            <Calendar className="w-8 h-8 text-burgundy-400 mx-auto mb-2" />
                            <p className="text-2xl font-bold text-white">{availability?.length || 0}</p>
                            <p className="text-neutral-500 text-sm">Days Available</p>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="rounded-2xl p-6" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                            <h2 className="text-lg font-semibold text-white mb-4 flex items-center space-x-2">
                                <Award className="w-5 h-5 text-burgundy-400" />
                            ...
                            {qualifications && qualifications.length > 0 ? (
                                <div className="flex flex-wrap gap-2">
                                    {qualifications.map((qual, index) => (
                                        <span
                                            key={index}
                                            className="bg-burgundy-500/10 text-burgundy-300 px-3 py-1 rounded-full text-sm border border-burgundy-500/20"
                                        >
                                            {qual}
                                        </span>
                                    ))}
                                ...
                                <p className="text-neutral-600 italic">No qualifications added yet</p>
                            )}
                        </div>
                            ...
                            {availability && availability.length > 0 ? (
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    {availability.map((slot, index) => (
                                        <div
                                            key={index}
                                            className="bg-emerald-500/10 text-emerald-400 px-4 py-3 rounded-xl text-center border border-emerald-500/20"
                                        >
                                ...
                                <p className="text-neutral-600 italic">No availability schedule set</p>
                            )}
                        </div>
                    </div>
                </div>
