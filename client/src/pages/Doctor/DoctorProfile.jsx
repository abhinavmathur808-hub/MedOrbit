            ...
            <CurvedWrapper>
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div className="rounded-xl p-4 text-center" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', boxShadow: 'var(--card-shadow)' }}>
                            <DollarSign className="w-8 h-8 text-rose-400 mx-auto mb-2" />
                            ...
                            {qualifications && qualifications.length > 0 ? (
                                <div className="flex flex-wrap gap-2">
                                    {qualifications.map((qual, index) => (
                                        <span
                                            key={index}
                                            className="bg-rose-500/10 text-rose-300 px-3 py-1 rounded-full text-sm border border-rose-500/20"
                                        >
                                            {qual}
                                        </span>
                                    ))}
